...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cryptolari-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cryptolari-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CryptoLari transaction") + "\n" +
              "  cryptolari-tx [options] -create [commands]   " + _("Create hex-encoded CryptoLari transaction") + "\n" +
              "\n";
